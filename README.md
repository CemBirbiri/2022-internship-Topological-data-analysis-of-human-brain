...
- Dimension reduction.
- Topological feature extraction to use in ML/AI pipelines.
- Clustering the data
- Finding subgroups/communities and the unique features that represent these communities.
